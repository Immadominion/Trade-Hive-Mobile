                                                  ...
                                                  valueOrDefault<String>(
                                                    valueOrDefault(
                                                        currentUserDocument
                                                            ?.bio,
                                                        ''),
                                                    'Trade Hive helps student entrepreneurs connect to their customers faster. Set up your bio today, to get customers faster.',
                                                  ),
                                                  textAlign: TextAlign.start,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsetsDirectional
                                                      ...
                                                      0.0, 8.0, 0.0, 0.0),
                                              child: Text(
                                                'Trade Hive helps student entrepreneurs connect to their customers faster. Set up your bio today, to get clients faster!.',
                                                textAlign: TextAlign.start,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelLarge,
