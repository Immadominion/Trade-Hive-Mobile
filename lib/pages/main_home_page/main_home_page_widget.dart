                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FlutterFlowChoiceChips(
                                                  options: const [
                                                    ChipData('Home Essentials'),
                                                    ChipData('Books'),
                                                    ChipData('Study Materials'),
                                                    ...
                                                    ChipData(
                                                        'Musical Instruments'),
                                                    ChipData('Beauty Products'),
                                                    ChipData('Gaming Consoles'),
                                                    ChipData(
                                                        'Art And Craft Supplies'),
                                                    ChipData('Room Decor'),
                                                    ChipData(
                                                        'Kitchen Appliances'),
                                                    ChipData('Outdoor Gear'),
                                                    ChipData('Bicycles'),
                                                    ChipData('Fashion Shoes'),
                                                    ChipData(
                                                        'Watches And Jewelry'),
                                                    ChipData('Event Tickets'),
                                                    ChipData('Home Appliances'),
                                                  ],
